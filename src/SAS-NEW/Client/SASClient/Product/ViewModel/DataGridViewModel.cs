...
namespace SDN.Product.ViewModel
{
    ...
    public class DataGridViewModel:ViewModelBase
    {
        ...
        public string AvgCostStr
        {
            get { return avgCostStr; }
            set
            {
                avgCostStr = value;
                OnPropertyChanged("AvgCostStr");
            }
        }
        ...
        {
            Difference = CountQty - SystemQty;
            if (SharedValues.StockType == Convert.ToInt16(Stock_Type.StockTake))
            {
                if (Difference != null)
                {
                ...
                if (pqDetails != null)
                {
                    ...
                    CountQty = 0;
                        ...
                        if (pqDetails.AvgCostPriceBeforeGSTd != null)
                        {
                            ...
                            {
                               AvgCostStr= Convert.ToString(pqDetails.AvgCostPriceBeforeGSTd);
                               AvgCost = Convert.ToString(pqDetails.AvgCostPriceBeforeGSTd);
                            }
                            else
                            {
                               AvgCostStr= Convert.ToString(pqDetails.StdPriceBeforeGSTd);
                    ...
                    if (SharedValues.StockType == Convert.ToInt16(Stock_Type.IncreaseDecreaseStock))
                    {
                        AvgCost = Convert.ToString(0);
                    }
