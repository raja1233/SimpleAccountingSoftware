namespace SDN.Sales
{
    ...
    public class SalesModule : IModule
    {
        ...
        public void Initialize()
        {
            ...
            this.container.RegisterType<ISalesQuotationListRepository, SalesQuotationListRepository>(new ContainerControlledLifetimeManager());

            // Resolving Instances with Unity
            this.regionManager.RegisterViewWithRegion(RegionNames.MainRegion,
                 () => this.container.Resolve<SalesQuotationListView>());
