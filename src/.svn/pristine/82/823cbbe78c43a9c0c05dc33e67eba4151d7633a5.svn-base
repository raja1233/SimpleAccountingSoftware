...
namespace SDN.Products.BL
{
    ...
    {
        List<ProductandServiceStockQuantitiesListEntity> pandSStockQuantities;
        ...
        {
            IPandSStockQuantitiesListDAL exportdata = new PandSStockQuantitiesListDAL();

            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
            pandSStockQuantities = exportdata.GetExportDataList(FileName);
            dt = ToDataTable(pandSStockQuantities);
            ds.Tables.Add(dt);
            ExportToExcel(ds, FileName);

            return pandSStockQuantities;
        }
