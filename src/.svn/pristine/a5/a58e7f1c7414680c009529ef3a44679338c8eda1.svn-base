...
{
    public class PaymentsToSuppliersListEntity: ViewModelBase
    {
        ...
        private List<PaymentsToSuppliersListEntity> _PaymentsToSuppliersList;
        private List<PaymentsToSuppliersListEntity> _PaymentsToSuppliersListcmb;
        private List<PaymentsToSuppliersListEntity> _PaymentsToSuppliersListcmbInv;
        private List<PaymentsToSuppliersListEntity> _PaymentsToSuppliersListcmbSup;
        private List<PaymentsToSuppliersListEntity> _PaymentsToSuppliersListcmbDebit;
        ...
        public List<PaymentsToSuppliersListEntity> PaymentsToSuppliersList
        {
            get { return _PaymentsToSuppliersList; }
            set
            {
                if (_PaymentsToSuppliersList != value)
                {
                    _PaymentsToSuppliersList = value;
                    OnPropertyChanged("PaymentsToSuppliersList");
                }
            }
        }
        public List<PaymentsToSuppliersListEntity> PaymentsToSuppliersListcmb
        {
            get { return _PaymentsToSuppliersListcmb; }
            set
            {
                if (_PaymentsToSuppliersListcmb != value)
                {
                    _PaymentsToSuppliersListcmb = value;
                    OnPropertyChanged("PaymentsToSuppliersListcmb");
                }
            }
        }
        public List<PaymentsToSuppliersListEntity> PaymentsToSuppliersListcmbInv
        {
            get { return _PaymentsToSuppliersListcmbInv; }
            set
            {
                if (_PaymentsToSuppliersListcmbInv != value)
                {
                    _PaymentsToSuppliersListcmbInv = value;
                    OnPropertyChanged("PaymentsToSuppliersListcmbInv");
                }
            }
        }
        public List<PaymentsToSuppliersListEntity> PaymentsToSuppliersListcmbSup
        {
            get { return _PaymentsToSuppliersListcmbSup; }
            set
            {
                if (_PaymentsToSuppliersListcmbSup != value)
                {
                    _PaymentsToSuppliersListcmbSup = value;
                    OnPropertyChanged("PaymentsToSuppliersListcmbSup");
                }
            }
        }
        public List<PaymentsToSuppliersListEntity> PaymentsToSuppliersListcmbDebit
        {
            get { return _PaymentsToSuppliersListcmbDebit; }
            set
            {
                if (_PaymentsToSuppliersListcmbDebit != value)
                {
                    _PaymentsToSuppliersListcmbDebit = value;
                    OnPropertyChanged("PaymentsToSuppliersListcmbDebit");
                }
            }
        }
