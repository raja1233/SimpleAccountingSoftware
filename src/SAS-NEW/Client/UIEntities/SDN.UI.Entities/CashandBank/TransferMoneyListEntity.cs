...
{
    public class TransferMoneyListEntity : ViewModelBase
    {
        ...
        private List<TransferMoneyListEntity> _TransferMoneyList;
        private List<TransferMoneyListEntity> _TransferMoneyListFrom;
        private List<TransferMoneyListEntity> _TransferMoneyListTo;
        private List<TransferMoneyListEntity> _TransferMoneyListCash;
        private ObservableCollection<TransferMoneyListEntity> _TransferMoneyListCat1;
        private ObservableCollection<TransferMoneyListEntity> _TransferMoneyListCat2;
        ...
        private int? _TransferMoneyListGridHeight;
        ...
        public List<TransferMoneyListEntity> TransferMoneyList
        {
            get
            {
                return _TransferMoneyList;
            }
            set
            {
                _TransferMoneyList = value;
                OnPropertyChanged("TransferMoneyList");
            }
        }
        public List<TransferMoneyListEntity> TransferMoneyListFrom
        {
            get
            {
                return _TransferMoneyListFrom;
            }
            set
            {
                _TransferMoneyListFrom = value;
                OnPropertyChanged("TransferMoneyListFrom");
            }
        }
        public List<TransferMoneyListEntity> TransferMoneyListTo
        {
            get
            {
                return _TransferMoneyListTo;
            }
            set
            {
                _TransferMoneyListTo = value;
                OnPropertyChanged("TransferMoneyListTo");
            }
        }
        public List<TransferMoneyListEntity> TransferMoneyListCash
        {
            get
            {
                return _TransferMoneyListCash;
            }
            set
            {
                _TransferMoneyListCash = value;
                OnPropertyChanged("TransferMoneyListCash");
            }
        }
        public ObservableCollection<TransferMoneyListEntity> TransferMoneyListCat1
        {
            get
            {
                return _TransferMoneyListCat1;
            }
            set
            {
                _TransferMoneyListCat1 = value;
                OnPropertyChanged("TransferMoneyListCat1");
            }
        }
        public ObservableCollection<TransferMoneyListEntity> TransferMoneyListCat2
        {
            get
            {
                return _TransferMoneyListCat2;
            }
            set
            {
                _TransferMoneyListCat2 = value;
                OnPropertyChanged("TransferMoneyListCat2");
            }
        }
        ...
        public int? TransferMoneyListGridHeight
        {
            get
            {
                return _TransferMoneyListGridHeight;
            }
            set
            {
                _TransferMoneyListGridHeight = value;
                OnPropertyChanged("TransferMoneyListGridHeight");
            }
        }
        ...
        public string FromAccountName
        {
            ...
            set
            {
                ...
                if (_FromAccountName != value)
                {
                    _FromAccountName = value;
                    OnPropertyChanged("FromAccountName");
                }
            }
        }
        public string ToAccountName
        {
            ...
            set
            {
                ...
                if (_ToAccountName != value)
                {
                    _ToAccountName = value;
                    OnPropertyChanged("ToAccountName");
                }
            }
        }
