...
namespace SDN.Products.BL
{
   public class PandSSoldBL: IPandSSoldBL
    {
        List<ProductandServiceSoldEntity> pandSSold;
        ...
        {
            IPandSSoldDAL exportdata = new PandSSoldDAL();

            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
            pandSSold = exportdata.GetExportDataList(jsondata, ExcincTax, IsSummary,FileName);
