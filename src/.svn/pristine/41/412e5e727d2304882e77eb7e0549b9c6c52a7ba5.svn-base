...
namespace SASClient.CashBank.ViewModels
{
    ...
    public class ReceiveMoneyViewModel: ReceiveMoneyEntity
    {
        ...
        private DateTime? _ReceiveDateCalender;
        ...
        public DateTime? ReceiveDateCalender
        {
            get
            {
                return _ReceiveDateCalender;
            }
            set
            {
                _ReceiveDateCalender = value;
                OnPropertyChanged("ReceiveDateCalender");
            }
        }
        ...
        {
            string date = this.DateFormat as string;
            CashChequeDateStr = Convert.ToDateTime(this.ReceiveDateCalender).ToString(date);
