...
{
    public class CustomerHistoryEntity : ViewModelBase
    {
        ...
        private List<CustomerHistoryEntity> _CustomerHistory;
        private List<CustomerHistoryEntity> _CustomerHistorycmb;
        private List<CustomerHistoryEntity> _CustomerHistorycmbInv;
        private List<CustomerHistoryEntity> _CustomerHistorycmbSup;
        private List<CustomerHistoryEntity> _CustomerHistorycmbCredit;
        ...
        public List<CustomerHistoryEntity> CustomerHistory
        {
            get { return _CustomerHistory; }
            set
            {
                if (_CustomerHistory != value)
                {
        ...
        public List<CustomerHistoryEntity> CustomerHistorycmb
        {
            get { return _CustomerHistorycmb; }
            set
            {
                if (_CustomerHistorycmb != value)
                {
                    _CustomerHistorycmb = value;
                    OnPropertyChanged("CustomerHistorycmb");
                }
            }
        }
        public List<CustomerHistoryEntity> CustomerHistorycmbInv
        {
            get { return _CustomerHistorycmbInv; }
            set
            {
                if (_CustomerHistorycmbInv != value)
                {
                    _CustomerHistorycmbInv = value;
                    OnPropertyChanged("CustomerHistorycmbInv");
                }
            }
        }
        public List<CustomerHistoryEntity> CustomerHistorycmbSup
        {
            get { return _CustomerHistorycmbSup; }
            set
            {
                if (_CustomerHistorycmbSup != value)
                {
                    _CustomerHistorycmbSup = value;
                    OnPropertyChanged("CustomerHistorycmbSup");
                }
            }
        }
        public List<CustomerHistoryEntity> CustomerHistorycmbCredit
        {
            get { return _CustomerHistorycmbCredit; }
            set
            {
                if (_CustomerHistorycmbCredit != value)
                {
                    _CustomerHistorycmbCredit = value;
                    OnPropertyChanged("CustomerHistorycmbCredit");
                }
            }
        }
