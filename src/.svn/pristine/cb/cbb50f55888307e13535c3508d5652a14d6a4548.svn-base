...
namespace SDN.UI.Entities.Sales
{
    ...
    public class PaymentFromCustomerEntity : ViewModelBase
    {
    ...
    public class PaymentFromCustomerForm : ViewModelBase
    {
        private List<CustomerEntity> lstCustomers;
        private PaymentFromCustomerEntity paymentFromCustomer;


        private List<PaymentFromCustomerDetailsEntity> paymentFromCustomerDetails { get; set; }

        public PaymentFromCustomerEntity PaymentFromCustomer
        {
            get
            {
            ...
            set
            {
                ...
                OnPropertyChanged("PaymentFromCustomer");
            }
        }

        public List<PaymentFromCustomerDetailsEntity> PaymentFromCustomerDetails
        {
            get
            {
            ...
            set
            {
                ...
                OnPropertyChanged("PaymentFromCustomerDetails");
            }
        }
