    ...
    public class SalesInvoiceEntity : BaseEntity
    {
     ...
     //   private ObservableCollection<SalesInvoiceDetailEntity> siDetailsEntity;
      ...
      //  private DateTime? createdDate;
        ...
        private string _NameToPrintSalesInvoice;
        ...
        public string NameToPrintSalesInvoice
        {
            get
            {
                return _NameToPrintSalesInvoice;
            }
            set
            {
                _NameToPrintSalesInvoice = value;
                OnPropertyChanged("NameToPrintSalesInvoice");
            }
        }
