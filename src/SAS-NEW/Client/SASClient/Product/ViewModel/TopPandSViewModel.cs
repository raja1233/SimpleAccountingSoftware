...
namespace SASClient.Product.ViewModel
{
    ...
    public class TopPandSViewModel : TopPandSEntity
    {
        ...
        private void LoadSupplierBackground(object sender, DoWorkEventArgs e)
        {
            ...
            var height = System.Windows.SystemParameters.PrimaryScreenHeight - headerRows - 66;
        ...
        private void RefreshData()
        {
            ...
            this.JsonData = pandsRepository.GetLastSelectionData(Convert.ToInt32(ScreenId.TopPandS));
            this.TopPandSList = pandsRepository.GetPandSList(this.JsonData).ToList();
