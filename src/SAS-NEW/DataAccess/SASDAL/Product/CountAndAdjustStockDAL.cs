                ...
                using (SASEntitiesEDM entities = new SASEntitiesEDM())
                {
                    ...
                    if(data!=null)
                    {
                        foreach (var d in data)
                        {
                            ...
                            if (psOld != null)
                            {
                                if (d.StockType == Convert.ToByte(Stock_Type.StockTake))
                                {
                                    psOld.PandS_Qty_in_stock = psOld.PandS_Qty_in_stock - d.Difference;
                                    psOld.PandS_Stock_Value = psOld.PandS_Stock_Value + Convert.ToDecimal(d.Amount);
                                    entities.SaveChanges();
                                }
                                else
                                {
                            ...
                            if (ps != null)
                            {
                                ...
                                {
                                    ps.PandS_Qty_in_stock = ps.PandS_Qty_in_stock + item.Difference;
                                    ps.PandS_Stock_Value = ps.PandS_Stock_Value - Convert.ToDecimal(item.AmountStr);
                                    entities.SaveChanges();
                                }
                                else
                                {
