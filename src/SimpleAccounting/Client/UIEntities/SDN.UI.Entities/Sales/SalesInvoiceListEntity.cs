...
{
    public class SalesInvoiceListEntity: ViewModelBase
    {
        ...
        private List<SalesInvoiceListEntity> _SalesInvoiceList;
        private List<SalesInvoiceListEntity> _SalesInvoiceListcmb;
        private List<SalesInvoiceListEntity> _SalesInvoiceListcmbInv;
        private List<SalesInvoiceListEntity> _SalesInvoiceListcmbSup;
        private List<SalesInvoiceListEntity> _SalesInvoiceListcmbCredit;
        ...
        public List<SalesInvoiceListEntity> SalesInvoiceList
        {
            get { return _SalesInvoiceList; }
            set
            {
                if (_SalesInvoiceList != value)
                {
                    _SalesInvoiceList = value;
                    OnPropertyChanged("SalesInvoiceList");
                }
            }
        }
        public List<SalesInvoiceListEntity> SalesInvoiceListcmb
        {
            get { return _SalesInvoiceListcmb; }
            set
            {
                if (_SalesInvoiceListcmb != value)
                {
                    _SalesInvoiceListcmb = value;
                    OnPropertyChanged("SalesInvoiceListcmb");
                }
            }
        }
        public List<SalesInvoiceListEntity> SalesInvoiceListcmbInv
        {
            get { return _SalesInvoiceListcmbInv; }
            set
            {
                if (_SalesInvoiceListcmbInv != value)
                {
                    _SalesInvoiceListcmbInv = value;
                    OnPropertyChanged("SalesInvoiceListcmbInv");
                }
            }
        }
        public List<SalesInvoiceListEntity> SalesInvoiceListcmbSup
        {
            get { return _SalesInvoiceListcmbSup; }
            set
            {
                if (_SalesInvoiceListcmbSup != value)
                {
                    _SalesInvoiceListcmbSup = value;
                    OnPropertyChanged("SalesInvoiceListcmbSup");
                }
            }
        }
        public List<SalesInvoiceListEntity> SalesInvoiceListcmbCredit
        {
            get { return _SalesInvoiceListcmbCredit; }
            set
            {
                if (_SalesInvoiceListcmbCredit != value)
                {
                    _SalesInvoiceListcmbCredit = value;
                    OnPropertyChanged("SalesInvoiceListcmbCredit");
                }
            }
        }
