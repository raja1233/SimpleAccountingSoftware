...
{
    public class SupplierCreditPaidDaysEntity : ViewModelBase
    {
        ...
        private List<SupplierCreditPaidDaysEntity> _SupplierCreditPaidDays;
        private List<SupplierCreditPaidDaysEntity> _SupplierCreditPaidDayscmb;
        private List<SupplierCreditPaidDaysEntity> _SupplierCreditPaidDayscmbInv;
        private List<SupplierCreditPaidDaysEntity> _SupplierCreditPaidDayscmbSup;
        private List<SupplierCreditPaidDaysEntity> _SupplierCreditPaidDayscmbCredit;
        ...
        private string _InvoiceAmountStr;
        private decimal? _InvoiceAmount;
        private DateTime? _PaymentDueDate;
        private DateTime? _InvoiceDate;
        private DateTime? _PaidDate;
        private int? _CreditDays;
        private int? _PaidInDays;
        private string _Name;
        private string _PaymentDueDateStr;
        private string _PaidDateStr;
        private string _CreditDaysStr;
        private string _PaidInDaysStr;
        private string _AveragePaidDays;

        #endregion

        #region Public Properties
        public string PaidInDaysStr
        {
            get
            {
                return _PaidInDaysStr;
            }
            set
            {
                _PaidInDaysStr = value;
                OnPropertyChanged("PaidInDaysStr");
            }
        }
        public string CreditDaysStr
        {
            get
            {
                return _CreditDaysStr;
            }
            set
            {
                _CreditDaysStr = value;
                OnPropertyChanged("CreditDaysStr");
            }
        }
        ...
        public string InvoiceAmountStr
        {
            ...
            {
                //return _InvoiceAmount;
                if (_InvoiceAmountStr == null)
                    return this._InvoiceAmountStr;
                else
                {
                    if (_InvoiceAmountStr != "")
                    {
                        var balance = _InvoiceAmountStr.Replace(",", "");
                        if (Convert.ToInt32(SharedValues.decimalPlaces) == 2)
                            return Convert.ToDecimal(balance).ToString("N", new CultureInfo(SharedValues.CurrencyName));
                        if (Convert.ToInt32(SharedValues.decimalPlaces) == 3)
                            return Convert.ToDecimal(balance).ToString("N3", new CultureInfo(SharedValues.CurrencyName));
        ...
        public List<SupplierCreditPaidDaysEntity> SupplierCreditPaidDays
        {
            get { return _SupplierCreditPaidDays; }
            set
            {
                if (_SupplierCreditPaidDays != value)
                {
                    _SupplierCreditPaidDays = value;
                    OnPropertyChanged("SupplierCreditPaidDays");
                }
            }
        }
        public List<SupplierCreditPaidDaysEntity> SupplierCreditPaidDayscmb
        {
            get { return _SupplierCreditPaidDayscmb; }
            set
            {
                if (_SupplierCreditPaidDayscmb != value)
                {
                    _SupplierCreditPaidDayscmb = value;
                    OnPropertyChanged("SupplierCreditPaidDayscmb");
                }
            }
        }
        public List<SupplierCreditPaidDaysEntity> SupplierCreditPaidDayscmbInv
        {
            get { return _SupplierCreditPaidDayscmbInv; }
            set
            {
                if (_SupplierCreditPaidDayscmbInv != value)
                {
                    _SupplierCreditPaidDayscmbInv = value;
                    OnPropertyChanged("SupplierCreditPaidDayscmbInv");
                }
            }
        }
        public List<SupplierCreditPaidDaysEntity> SupplierCreditPaidDayscmbSup
        {
            get { return _SupplierCreditPaidDayscmbSup; }
            set
            {
                if (_SupplierCreditPaidDayscmbSup != value)
                {
                    _SupplierCreditPaidDayscmbSup = value;
                    OnPropertyChanged("SupplierCreditPaidDayscmbSup");
                }
            }
        }
        public List<SupplierCreditPaidDaysEntity> SupplierCreditPaidDayscmbCredit
        {
            get { return _SupplierCreditPaidDayscmbCredit; }
            set
            {
                if (_SupplierCreditPaidDayscmbCredit != value)
                {
                    _SupplierCreditPaidDayscmbCredit = value;
                    OnPropertyChanged("SupplierCreditPaidDayscmbCredit");
                }
            }
        }
        ...
        public string AveragePaidDays
        {
            get
            {
                //return _AveragePaidDays;

                // return _TotalM1Str;
                if (_AveragePaidDays == null)
                    return this._AveragePaidDays;
                else
                {
                    if (_AveragePaidDays != "")
                    {
                        var balance = _AveragePaidDays.Replace(",", "");
                        return Convert.ToDecimal(balance).ToString("N0", new CultureInfo(SharedValues.CurrencyName));
                    }
                    else
                        return this._AveragePaidDays;
            ...
            set
            {
                if (_AveragePaidDays != value)
                {
                    _AveragePaidDays = value;
                    OnPropertyChanged("AveragePaidDays");
                }
            }
        }
