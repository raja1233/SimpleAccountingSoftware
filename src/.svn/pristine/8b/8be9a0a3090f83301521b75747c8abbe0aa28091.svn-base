...
namespace SDN.Settings.ViewModels
{
    ...
    class TaxCodesAndRatesViewModel:ViewModelBase
    {
        ...
        public TaxCodesAndRatesViewModel()
        {
                    ...
                    if (result == MessageBoxResult.Yes)
                    {
                        ...
                        if (compEntities.Comp_Reg_No == null)
                        {
                            if (taxModel.Predefined == false)
                            {
                                ...
                                {
                                    MessageBox.Show("Your Company is not registered to collect GST/VAT.", "Warning Message", MessageBoxButton.OK);
                                }
                            }
                        }
                        else
        ...
        public string ValidateTaxCodesAndRates(TaxModel taxModel)
        {
            ...
            if (taxModel.TaxDescription == null || taxModel.TaxDescription=="")
            {
                msg.Append("Tax Description is Required.\n");
            }

            if (taxModel.TaxCode == null || taxModel.TaxCode=="")
            {
