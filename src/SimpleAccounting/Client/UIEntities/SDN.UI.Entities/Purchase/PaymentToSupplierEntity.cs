...
{
   public class PaymentToSupplierEntity : ViewModelBase
    {
   ...
   public  class PaymentToSupplierForm : ViewModelBase
    {
        private List<SupplierDetailEntity> lstSuppliers;
        private PaymentToSupplierEntity paymentToSupplier;


        private List<PaymentToSupplierDetailsEntity> paymentToSupplierDetails { get; set; }

        public PaymentToSupplierEntity PaymentToSupplier
        {
            get
            {
            ...
            set
            {
                ...
                OnPropertyChanged("PaymentToSupplier");
            }
        }

        public List<PaymentToSupplierDetailsEntity> PaymentToSupplierDetails
        {
            get
            {
            ...
            set
            {
                ...
                OnPropertyChanged("PaymentToSupplierDetails");
            }
        }
