...
namespace SDN.UI.Entities.Sales
{
    ...
    public class SalesOrderListEntity:ViewModelBase
    {
        ...
        private List<SalesOrderListEntity> _SalesOrderList;
        private List<SalesOrderListEntity> _SalesOrderListcmb;
        ...
        public int SOGridHeight
        {
            get
            {
                return _SOGridHeight;
            }
            set
            {
                _SOGridHeight = value;
                OnPropertyChanged("SOGridHeight");
            }
        }
        ...
        public List<SalesOrderListEntity> SalesOrderList
        {
            get { return _SalesOrderList; }
            set
            {
                if (_SalesOrderList != value)
                {
        ...
        public List<SalesOrderListEntity> SalesOrderListcmb
        {
            get { return _SalesOrderListcmb; }
            set
            {
                if (_SalesOrderListcmb != value)
                {
                    _SalesOrderListcmb = value;
                    OnPropertyChanged("SalesOrderListcmb");
                }
            }
        }
        public List<SalesOrderListEntity> SalesOrderListcmbONo
        {
            get { return _SalesOrderListcmb; }
            set
            {
                ...
                {
                    _SalesOrderListcmb = value;
                    OnPropertyChanged("SalesOrderListcmbONo");
                }
            }
        }
        public List<SalesOrderListEntity> SalesOrderListcmbSup
        {
            get { return _SalesOrderListcmb; }
            set
            {
                ...
                {
                    _SalesOrderListcmb = value;
                    OnPropertyChanged("SalesOrderListcmbSup");
                }
            }
        }
        ...
        public string TotalOrderAmount
        {
            get
            {
                ...
                else
                {
                    if (totalOrderAmount != "")
                    {
                        var balance = totalOrderAmount.Replace(",", "");
                        if (Convert.ToInt32(SharedValues.decimalPlaces) == 2)
                            return Convert.ToDecimal(balance).ToString("N", new CultureInfo(SharedValues.CurrencyName));
                        if (Convert.ToInt32(SharedValues.decimalPlaces) == 3)
                            return Convert.ToDecimal(balance).ToString("N3", new CultureInfo(SharedValues.CurrencyName));
            ...
            set
            {
                ...
                OnPropertyChanged("TotalOrderAmount");
            }
        }
        ...
        public string TotalDepositAmount
        {
            get
            {
                ...
                else
                {
                    ...
                    {
                        var balance = totalDepositAmount.Replace(",", "");
                        if (Convert.ToInt32(SharedValues.decimalPlaces) == 2)
                            return Convert.ToDecimal(balance).ToString("N", new CultureInfo(SharedValues.CurrencyName));
                        if (Convert.ToInt32(SharedValues.decimalPlaces) == 3)
                            return Convert.ToDecimal(balance).ToString("N3", new CultureInfo(SharedValues.CurrencyName));
            ...
            set
            {
                ...
                OnPropertyChanged("TotalDepositAmount");
            }
        }
        #endregion
    }
