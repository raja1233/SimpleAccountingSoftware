...
{
    public class ReceiveMoneyListEntity : ViewModelBase
    {
        ...
        private List<ReceiveMoneyListEntity> _ReceiveMoneyList;
        private List<ReceiveMoneyListEntity> _ReceiveMoneyListCode;
        private List<ReceiveMoneyListEntity> _ReceiveMoneyListName;
        private List<ReceiveMoneyListEntity> _ReceiveMoneyListCash;
        private ObservableCollection<ReceiveMoneyListEntity> _ReceiveMoneyListCat1;
        private ObservableCollection<ReceiveMoneyListEntity> _ReceiveMoneyListCat2;
        ...
        private int? _ReceiveMoneyListGridHeight;
        ...
        public List<ReceiveMoneyListEntity> ReceiveMoneyList
        {
            get
            {
                return _ReceiveMoneyList;
            }
            set
            {
                _ReceiveMoneyList = value;
                OnPropertyChanged("ReceiveMoneyList");
            }
        }
        public List<ReceiveMoneyListEntity> ReceiveMoneyListCode
        {
            get
            {
                return _ReceiveMoneyListCode;
            }
            set
            {
                _ReceiveMoneyListCode = value;
                OnPropertyChanged("ReceiveMoneyListCode");
            }
        }
        public List<ReceiveMoneyListEntity> ReceiveMoneyListName
        {
            get
            {
                return _ReceiveMoneyListName;
            }
            set
            {
                _ReceiveMoneyListName = value;
                OnPropertyChanged("ReceiveMoneyListName");
            }
        }
        public List<ReceiveMoneyListEntity> ReceiveMoneyListCash
        {
            get
            {
                return _ReceiveMoneyListCash;
            }
            set
            {
                _ReceiveMoneyListCash = value;
                OnPropertyChanged("ReceiveMoneyListCash");
            }
        }
        public ObservableCollection<ReceiveMoneyListEntity> ReceiveMoneyListCat1
        {
            get
            {
                return _ReceiveMoneyListCat1;
            }
            set
            {
                _ReceiveMoneyListCat1 = value;
                OnPropertyChanged("ReceiveMoneyListCat1");
            }
        }
        public ObservableCollection<ReceiveMoneyListEntity> ReceiveMoneyListCat2
        {
            get
            {
                return _ReceiveMoneyListCat2;
            }
            set
            {
                _ReceiveMoneyListCat2 = value;
                OnPropertyChanged("ReceiveMoneyListCat2");
            }
        }
        ...
        public int? ReceiveMoneyListGridHeight
        {
            get
            {
                return _ReceiveMoneyListGridHeight;
            }
            set
            {
                _ReceiveMoneyListGridHeight = value;
                OnPropertyChanged("ReceiveMoneyListGridHeight");
            }
        }
