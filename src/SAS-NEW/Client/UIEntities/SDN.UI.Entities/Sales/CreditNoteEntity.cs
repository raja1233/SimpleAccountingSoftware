...
namespace SDN.UI.Entities.Sales
{
    public class CreditNoteEntity: BaseEntity
    {
        ...
        private string customerDebitNoteDateStr;
        ...
        public string CustomerDebitNoteDateStr
        {
            get
            {
                return customerDebitNoteDateStr;
            }
            set
            {
                customerDebitNoteDateStr = value;
                OnPropertyChanged("CustomerDebitNoteDateStr");
            }
        }
