...
namespace SDN.UI.Entities.Sales
{
    ...
    public class RefundToCustomersListEntity:ViewModelBase
    {
        ...
        private List<RefundToCustomersListEntity> _RefundToCustomersList;
        private List<RefundToCustomersListEntity> _RefundToCustomersListcmb;
        private List<RefundToCustomersListEntity> _RefundToCustomersListcmbInv;
        private List<RefundToCustomersListEntity> _RefundToCustomersListcmbSup;
        private List<RefundToCustomersListEntity> _RefundToCustomersListcmbDebit;
        ...
        public List<RefundToCustomersListEntity> RefundToCustomersList
        {
            get { return _RefundToCustomersList; }
            set
            {
                if (_RefundToCustomersList != value)
                {
                    _RefundToCustomersList = value;
                    OnPropertyChanged("RefundToCustomersList");
                }
            }
        }
        public List<RefundToCustomersListEntity> RefundToCustomersListcmb
        {
            get { return _RefundToCustomersListcmb; }
            set
            {
                if (_RefundToCustomersListcmb != value)
                {
                    _RefundToCustomersListcmb = value;
                    OnPropertyChanged("RefundToCustomersListcmb");
                }
            }
        }
        public List<RefundToCustomersListEntity> RefundToCustomersListcmbInv
        {
            get { return _RefundToCustomersListcmbInv; }
            set
            {
                if (_RefundToCustomersListcmbInv != value)
                {
                    _RefundToCustomersListcmbInv = value;
                    OnPropertyChanged("RefundToCustomersListcmbInv");
                }
            }
        }
        public List<RefundToCustomersListEntity> RefundToCustomersListcmbSup
        {
            get { return _RefundToCustomersListcmbSup; }
            set
            {
                if (_RefundToCustomersListcmbSup != value)
                {
                    _RefundToCustomersListcmbSup = value;
                    OnPropertyChanged("RefundToCustomersListcmbSup");
                }
            }
        }
        public List<RefundToCustomersListEntity> RefundToCustomersListcmbDebit
        {
            get { return _RefundToCustomersListcmbDebit; }
            set
            {
                if (_RefundToCustomersListcmbDebit != value)
                {
                    _RefundToCustomersListcmbDebit = value;
                    OnPropertyChanged("RefundToCustomersListcmbDebit");
                }
            }
        }
