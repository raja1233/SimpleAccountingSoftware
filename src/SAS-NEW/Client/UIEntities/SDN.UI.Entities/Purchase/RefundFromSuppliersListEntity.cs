...
namespace SDN.UI.Entities.Purchase
{
    ...
    public class RefundFromSuppliersListEntity:ViewModelBase
    {
        ...
        private List<RefundFromSuppliersListEntity> _RefundFromSuppliersList;
        private List<RefundFromSuppliersListEntity> _RefundFromSuppliersListcmb;
        private List<RefundFromSuppliersListEntity> _RefundFromSuppliersListcmbInv;
        private List<RefundFromSuppliersListEntity> _RefundFromSuppliersListcmbSup;
        private List<RefundFromSuppliersListEntity> _RefundFromSuppliersListcmbDebit;
        ...
        public List<RefundFromSuppliersListEntity> RefundFromSuppliersList
        {
            get { return _RefundFromSuppliersList; }
            set
            {
                if (_RefundFromSuppliersList != value)
                {
                    _RefundFromSuppliersList = value;
                    OnPropertyChanged("RefundFromSuppliersList");
                }
            }
        }
        public List<RefundFromSuppliersListEntity> RefundFromSuppliersListcmb
        {
            get { return _RefundFromSuppliersListcmb; }
            set
            {
                if (_RefundFromSuppliersListcmb != value)
                {
                    _RefundFromSuppliersListcmb = value;
                    OnPropertyChanged("RefundFromSuppliersListcmb");
                }
            }
        }
        public List<RefundFromSuppliersListEntity> RefundFromSuppliersListcmbInv
        {
            get { return _RefundFromSuppliersListcmbInv; }
            set
            {
                if (_RefundFromSuppliersListcmbInv != value)
                {
                    _RefundFromSuppliersListcmbInv = value;
                    OnPropertyChanged("RefundFromSuppliersListcmbInv");
                }
            }
        }
        public List<RefundFromSuppliersListEntity> RefundFromSuppliersListcmbSup
        {
            get { return _RefundFromSuppliersListcmbSup; }
            set
            {
                if (_RefundFromSuppliersListcmbSup != value)
                {
                    _RefundFromSuppliersListcmbSup = value;
                    OnPropertyChanged("RefundFromSuppliersListcmbSup");
                }
            }
        }
        public List<RefundFromSuppliersListEntity> RefundFromSuppliersListcmbDebit
        {
            get { return _RefundFromSuppliersListcmbDebit; }
            set
            {
                if (_RefundFromSuppliersListcmbDebit != value)
                {
                    _RefundFromSuppliersListcmbDebit = value;
                    OnPropertyChanged("RefundFromSuppliersListcmbDebit");
                }
            }
        }
