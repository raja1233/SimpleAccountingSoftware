...
namespace SDN.Purchasings.DAL
{
    public class SupplierDAL : ISupplierDAL
    {
        ...
        {
            List<SupplierDetailEntity> suppliersource = entities.Suppliers.Where(x => x.IsDeleted != true && x.Sup_Inactive!="Y").Select(x => new SupplierDetailEntity
            {
                ID = x.ID,
       ...
       public List<SupplierDetailEntity> GetSupplierList()
        {
            List<SupplierDetailEntity> lstSuppliers = new List<SupplierDetailEntity>();
            try
            {

                using (SASEntitiesEDM entities = new SASEntitiesEDM())
                {
                    lstSuppliers = entities.Database.SqlQuery<SupplierDetailEntity>("USP_GetSuppliersList").ToList();
