    ...
    public class RefundFromSuppliersListViewModel: RefundFromSuppliersListEntity
    {
        ...
        void Search(object param)
        {
            ...
            if (Count != 0)
            {
                ...
                var results = purchaseRepository.SaveSearchJson(jsonSearch, Convert.ToInt32(ScreenId.RefundFromSuppliersList), "Payments_To_Suppliers_List");
                if (Count != 0)
                {
        ...
        private void RefreshData()
        {
            ...
            this.JsonData = purchaseRepository.GetLastSelectionData(Convert.ToInt32(ScreenId.RefundFromSuppliersList));
            this.RefundFromSuppliersList = purchaseRepository.GetAllPurInvoiceJson(this.JsonData).OrderBy(e => e.SupplierName).ToList();
