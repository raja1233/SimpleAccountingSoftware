...
{
    public class AuditTrailListEntity : ViewModelBase
    {
        ...
        private List<AuditTrailListEntity> _AuditTrailList;
        private List<AuditTrailListEntity> _AuditTrailListcmb;
        private List<AuditTrailListEntity> _AuditTrailListcmbDate;
        private List<AuditTrailListEntity> _AuditTrailListcmbAmount;
        private List<AuditTrailListEntity> _AuditTrailListcmbUserName;
        private List<AuditTrailListEntity> _AuditTrailListcmbName;
        private List<AuditTrailListEntity> _AuditTrailListcmbTranNo;
        private List<AuditTrailListEntity> _AuditTrailListcmbTranType;
        ...
        public List<AuditTrailListEntity> AuditTrailList
        {
            get { return _AuditTrailList; }
            set
            {
                if (_AuditTrailList != value)
                {
                    _AuditTrailList = value;
                    OnPropertyChanged("AuditTrailList");
                }
            }
        }
        public List<AuditTrailListEntity> AuditTrailListcmb
        {
            get { return _AuditTrailListcmb; }
            set
            {
                if (_AuditTrailListcmb != value)
                {
                    _AuditTrailListcmb = value;
                    OnPropertyChanged("AuditTrailListcmb");
                }
            }
        }
        public List<AuditTrailListEntity> AuditTrailListcmbDate
        {
            get { return _AuditTrailListcmbDate; }
            set
            {
                if (_AuditTrailListcmbDate != value)
                {
                    _AuditTrailListcmbDate = value;
                    OnPropertyChanged("AuditTrailListcmbDate");
                }
            }
        }
        public List<AuditTrailListEntity> AuditTrailListcmbAmount
        {
            get { return _AuditTrailListcmbAmount; }
            set
            {
                if (_AuditTrailListcmbAmount != value)
                {
                    _AuditTrailListcmbAmount = value;
                    OnPropertyChanged("AuditTrailListcmbAmount");
                }
            }
        }
        public List<AuditTrailListEntity> AuditTrailListcmbUserName
        {
            get { return _AuditTrailListcmbUserName; }
            set
            {
                if (_AuditTrailListcmbUserName != value)
                {
                    _AuditTrailListcmbUserName = value;
                    OnPropertyChanged("AuditTrailListcmbUserName");
                }
            }
        }
        public List<AuditTrailListEntity> AuditTrailListcmbName
        {
            get { return _AuditTrailListcmbName; }
            set
            {
                if (_AuditTrailListcmbName != value)
                {
                    _AuditTrailListcmbName = value;
                    OnPropertyChanged("AuditTrailListcmbName");
                }
            }
        }
        public List<AuditTrailListEntity> AuditTrailListcmbTranNo
        {
            get { return _AuditTrailListcmbTranNo; }
            set
            {
                if (_AuditTrailListcmbTranNo != value)
                {
                    _AuditTrailListcmbTranNo = value;
                    OnPropertyChanged("AuditTrailListcmbTranNo");
                }
            }
        }
        public List<AuditTrailListEntity> AuditTrailListcmbTranType
        {
            get { return _AuditTrailListcmbTranType; }
            set
            {
                if (_AuditTrailListcmbTranType != value)
                {
                    _AuditTrailListcmbTranType = value;
                    OnPropertyChanged("AuditTrailListcmbTranType");
                }
            }
        }
