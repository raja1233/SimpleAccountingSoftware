    ...
    public class RefundToCustomersListViewModel: RefundToCustomersListEntity
    {
        ...
        void Search(object param)
        {
            ...
            if (Count != 0)
            {
                ...
                var results = purchaseRepository.SaveSearchJson(jsonSearch, Convert.ToInt32(ScreenId.RefundToCustomersList), "RefundToCustomers_List");
                if (Count != 0)
        ...
        private void RefreshData()
        {
            ...
            this.RefundToCustomersList = purchaseRepository.GetAllPurInvoiceJson(this.JsonData).ToList();
