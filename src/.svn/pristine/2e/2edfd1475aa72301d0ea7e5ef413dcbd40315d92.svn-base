...
namespace SDN.UI.Entities.Purchase
{
    public class AdjustDebitNoteEntity : ViewModelBase
    {
        ...
        private string _AdjustDebitNoteDateStr;
        ...
        public string TotalAdjutedAmount
        {
            ...
            set
            {
                ...
                OnPropertyChanged("TotalAdjutedAmount");
            }
        ...
        public string AdjustDebitNoteDateStr
        {
            get
            {
                return _AdjustDebitNoteDateStr;
            }
            set
            {
                _AdjustDebitNoteDateStr = value;
                OnPropertyChanged("AdjustDebitNoteDateStr");
            }
        }
