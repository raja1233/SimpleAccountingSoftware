...
{
    public class SupplierPaymentDueDaysEntity: ViewModelBase
    {
        ...
        private List<SupplierPaymentDueDaysEntity> _ListDueDays;
        private List<SupplierPaymentDueDaysEntity> _ListDueDayscmbSup;
        ...
        public List<SupplierPaymentDueDaysEntity> ListDueDays
        {
        ...
        public List<SupplierPaymentDueDaysEntity> ListDueDayscmbSup
        {
