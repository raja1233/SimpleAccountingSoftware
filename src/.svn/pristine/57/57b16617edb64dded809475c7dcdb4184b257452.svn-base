...
namespace SDN.UI.Entities
{
    public class DebitNoteListEntity : ViewModelBase
    {
        ...
        public string DebitNoteAmountStr
        {
            get
            {
                return _DebitNoteAmountStr;
            }
            set
            {
                _DebitNoteAmountStr = value;
                OnPropertyChanged("DebitNoteAmountStr");
            }
        }
        ...
        public string DebitNoteDateStr
        {
            get
            {
                return _DebitNoteDateStr;
            }
            set
            {
                _DebitNoteDateStr = value;
                OnPropertyChanged("DebitNoteDateStr");
            }
        }
        ...
        public string DebitDateStr
        {
            get
            {
                return _DebitDateStr;
            }
            set
            {
                _DebitDateStr = value;
                OnPropertyChanged("DebitDateStr");
            }
        }
        ...
        /// <summary>
        /// TotalDebitCashAmount
        /// </summary>
        private string totalDebitCashAmount;
        public string TotalDebitCashAmount
        {get
            {
                if (totalDebitCashAmount == null)
                    return this.totalDebitCashAmount;
                else
                {
                    if (totalDebitCashAmount != "")
                    {
                        var balance = totalDebitCashAmount.Replace(",", "");
                        if (Convert.ToInt32(SharedValues.decimalPlaces) == 2)
                            return Convert.ToDecimal(balance).ToString("N", new CultureInfo(SharedValues.CurrencyName));
                        if (Convert.ToInt32(SharedValues.decimalPlaces) == 3)
                            return Convert.ToDecimal(balance).ToString("N3", new CultureInfo(SharedValues.CurrencyName));
        ...
        set
            {
                totalDebitCashAmount = value;
                OnPropertyChanged("TotalDebitCashAmount");
    }
        ...
        public string DebitAmountStr
        {
            ...
            set
            {
                _DebitAmountStr = value;
                OnPropertyChanged("DebitAmountStr");
            }
        }
